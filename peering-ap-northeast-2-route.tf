resource "aws_route" "ap-northeast-2_us-east-1" {
  provider = aws.ap-northeast-2
  route_table_id = var.ap-northeast-2.route_table_id

  count = local.ap-northeast-2 && local.us-east-1 ? 1 : 0
...
resource "aws_route" "ap-northeast-2_us-east-2" {
  provider = aws.ap-northeast-2
  route_table_id = var.ap-northeast-2.route_table_id

  count = local.ap-northeast-2 && local.us-east-2 ? 1 : 0
...
resource "aws_route" "ap-northeast-2_us-west-1" {
  provider = aws.ap-northeast-2
  route_table_id = var.ap-northeast-2.route_table_id

  count = local.ap-northeast-2 && local.us-west-1 ? 1 : 0
...
resource "aws_route" "ap-northeast-2_us-west-2" {
  provider = aws.ap-northeast-2
  route_table_id = var.ap-northeast-2.route_table_id

  count = local.ap-northeast-2 && local.us-west-2 ? 1 : 0
...
resource "aws_route" "ap-northeast-2_ap-east-1" {
  provider = aws.ap-northeast-2
  route_table_id = var.ap-northeast-2.route_table_id

  count = local.ap-northeast-2 && local.ap-east-1 ? 1 : 0
...
resource "aws_route" "ap-northeast-2_ap-south-1" {
  provider = aws.ap-northeast-2
  route_table_id = var.ap-northeast-2.route_table_id

  count = local.ap-northeast-2 && local.ap-south-1 ? 1 : 0
...
resource "aws_route" "ap-northeast-2_ap-southeast-1" {
  provider = aws.ap-northeast-2
  route_table_id = var.ap-northeast-2.route_table_id
...
resource "aws_route" "ap-northeast-2_ap-southeast-2" {
  provider = aws.ap-northeast-2
  route_table_id = var.ap-northeast-2.route_table_id
...
resource "aws_route" "ap-northeast-2_ap-northeast-1" {
  provider = aws.ap-northeast-2
  route_table_id = var.ap-northeast-2.route_table_id
...
resource "aws_route" "ap-northeast-2_ca-central-1" {
  provider = aws.ap-northeast-2
  route_table_id = var.ap-northeast-2.route_table_id
...
resource "aws_route" "ap-northeast-2_eu-central-1" {
  provider = aws.ap-northeast-2
  route_table_id = var.ap-northeast-2.route_table_id
...
resource "aws_route" "ap-northeast-2_eu-west-1" {
  provider = aws.ap-northeast-2
  route_table_id = var.ap-northeast-2.route_table_id
...
resource "aws_route" "ap-northeast-2_eu-west-2" {
  provider = aws.ap-northeast-2
  route_table_id = var.ap-northeast-2.route_table_id
...
resource "aws_route" "ap-northeast-2_eu-west-3" {
  provider = aws.ap-northeast-2
  route_table_id = var.ap-northeast-2.route_table_id
...
resource "aws_route" "ap-northeast-2_eu-north-1" {
  provider = aws.ap-northeast-2
  route_table_id = var.ap-northeast-2.route_table_id
...
resource "aws_route" "ap-northeast-2_me-south-1" {
  provider = aws.ap-northeast-2
  route_table_id = var.ap-northeast-2.route_table_id
...
resource "aws_route" "ap-northeast-2_sa-east-1" {
  provider = aws.ap-northeast-2
  route_table_id = var.ap-northeast-2.route_table_id
