resource "aws_vpc_peering_connection" "ap-east-1_ap-south-1" {
  provider = aws.ap-east-1
  vpc_id = var.ap-east-1.vpc_id
...
resource "aws_vpc_peering_connection" "ap-east-1_ap-northeast-2" {
  provider = aws.ap-east-1
  vpc_id = var.ap-east-1.vpc_id
...
resource "aws_vpc_peering_connection" "ap-east-1_ap-southeast-1" {
  provider = aws.ap-east-1
  vpc_id = var.ap-east-1.vpc_id
...
resource "aws_vpc_peering_connection" "ap-east-1_ap-southeast-2" {
  provider = aws.ap-east-1
  vpc_id = var.ap-east-1.vpc_id
...
resource "aws_vpc_peering_connection" "ap-east-1_ap-northeast-1" {
  provider = aws.ap-east-1
  vpc_id = var.ap-east-1.vpc_id
...
resource "aws_vpc_peering_connection" "ap-east-1_ca-central-1" {
  provider = aws.ap-east-1
  vpc_id = var.ap-east-1.vpc_id
...
resource "aws_vpc_peering_connection" "ap-east-1_eu-central-1" {
  provider = aws.ap-east-1
  vpc_id = var.ap-east-1.vpc_id
...
resource "aws_vpc_peering_connection" "ap-east-1_eu-west-1" {
  provider = aws.ap-east-1
  vpc_id = var.ap-east-1.vpc_id
...
resource "aws_vpc_peering_connection" "ap-east-1_eu-west-2" {
  provider = aws.ap-east-1
  vpc_id = var.ap-east-1.vpc_id
...
resource "aws_vpc_peering_connection" "ap-east-1_eu-west-3" {
  provider = aws.ap-east-1
  vpc_id = var.ap-east-1.vpc_id
...
resource "aws_vpc_peering_connection" "ap-east-1_eu-north-1" {
  provider = aws.ap-east-1
  vpc_id = var.ap-east-1.vpc_id
...
resource "aws_vpc_peering_connection" "ap-east-1_me-south-1" {
  provider = aws.ap-east-1
  vpc_id = var.ap-east-1.vpc_id
...
resource "aws_vpc_peering_connection" "ap-east-1_sa-east-1" {
  provider = aws.ap-east-1
  vpc_id = var.ap-east-1.vpc_id
