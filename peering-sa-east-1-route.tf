resource "aws_route" "sa-east-1_us-east-1" {
  provider = aws.sa-east-1
  route_table_id = var.sa-east-1.route_table_id

  count = local.sa-east-1 && local.us-east-1 ? 1 : 0
...
resource "aws_route" "sa-east-1_us-east-2" {
  provider = aws.sa-east-1
  route_table_id = var.sa-east-1.route_table_id

  count = local.sa-east-1 && local.us-east-2 ? 1 : 0
...
resource "aws_route" "sa-east-1_us-west-1" {
  provider = aws.sa-east-1
  route_table_id = var.sa-east-1.route_table_id

  count = local.sa-east-1 && local.us-west-1 ? 1 : 0
...
resource "aws_route" "sa-east-1_us-west-2" {
  provider = aws.sa-east-1
  route_table_id = var.sa-east-1.route_table_id

  count = local.sa-east-1 && local.us-west-2 ? 1 : 0
...
resource "aws_route" "sa-east-1_ap-east-1" {
  provider = aws.sa-east-1
  route_table_id = var.sa-east-1.route_table_id

  count = local.sa-east-1 && local.ap-east-1 ? 1 : 0
...
resource "aws_route" "sa-east-1_ap-south-1" {
  provider = aws.sa-east-1
  route_table_id = var.sa-east-1.route_table_id

  count = local.sa-east-1 && local.ap-south-1 ? 1 : 0
...
resource "aws_route" "sa-east-1_ap-northeast-2" {
  provider = aws.sa-east-1
  route_table_id = var.sa-east-1.route_table_id

  count = local.sa-east-1 && local.ap-northeast-2 ? 1 : 0
...
resource "aws_route" "sa-east-1_ap-southeast-1" {
  provider = aws.sa-east-1
  route_table_id = var.sa-east-1.route_table_id

  count = local.sa-east-1 && local.ap-southeast-1 ? 1 : 0
...
resource "aws_route" "sa-east-1_ap-southeast-2" {
  provider = aws.sa-east-1
  route_table_id = var.sa-east-1.route_table_id

  count = local.sa-east-1 && local.ap-southeast-2 ? 1 : 0
...
resource "aws_route" "sa-east-1_ap-northeast-1" {
  provider = aws.sa-east-1
  route_table_id = var.sa-east-1.route_table_id

  count = local.sa-east-1 && local.ap-northeast-1 ? 1 : 0
...
resource "aws_route" "sa-east-1_ca-central-1" {
  provider = aws.sa-east-1
  route_table_id = var.sa-east-1.route_table_id

  count = local.sa-east-1 && local.ca-central-1 ? 1 : 0
...
resource "aws_route" "sa-east-1_eu-central-1" {
  provider = aws.sa-east-1
  route_table_id = var.sa-east-1.route_table_id

  count = local.sa-east-1 && local.eu-central-1 ? 1 : 0
...
resource "aws_route" "sa-east-1_eu-west-1" {
  provider = aws.sa-east-1
  route_table_id = var.sa-east-1.route_table_id

  count = local.sa-east-1 && local.eu-west-1 ? 1 : 0
...
resource "aws_route" "sa-east-1_eu-west-2" {
  provider = aws.sa-east-1
  route_table_id = var.sa-east-1.route_table_id

  count = local.sa-east-1 && local.eu-west-2 ? 1 : 0
...
resource "aws_route" "sa-east-1_eu-west-3" {
  provider = aws.sa-east-1
  route_table_id = var.sa-east-1.route_table_id

  count = local.sa-east-1 && local.eu-west-3 ? 1 : 0
...
resource "aws_route" "sa-east-1_eu-north-1" {
  provider = aws.sa-east-1
  route_table_id = var.sa-east-1.route_table_id

  count = local.sa-east-1 && local.eu-north-1 ? 1 : 0
...
resource "aws_route" "sa-east-1_me-south-1" {
  provider = aws.sa-east-1
  route_table_id = var.sa-east-1.route_table_id

  count = local.sa-east-1 && local.me-south-1 ? 1 : 0
