resource "aws_route" "ca-central-1_us-east-1" {
  provider = aws.ca-central-1
  route_table_id = var.ca-central-1.route_table_id

  count = local.ca-central-1 && local.us-east-1 ? 1 : 0
...
resource "aws_route" "ca-central-1_us-east-2" {
  provider = aws.ca-central-1
  route_table_id = var.ca-central-1.route_table_id

  count = local.ca-central-1 && local.us-east-2 ? 1 : 0
...
resource "aws_route" "ca-central-1_us-west-1" {
  provider = aws.ca-central-1
  route_table_id = var.ca-central-1.route_table_id

  count = local.ca-central-1 && local.us-west-1 ? 1 : 0
...
resource "aws_route" "ca-central-1_us-west-2" {
  provider = aws.ca-central-1
  route_table_id = var.ca-central-1.route_table_id

  count = local.ca-central-1 && local.us-west-2 ? 1 : 0
...
resource "aws_route" "ca-central-1_ap-east-1" {
  provider = aws.ca-central-1
  route_table_id = var.ca-central-1.route_table_id

  count = local.ca-central-1 && local.ap-east-1 ? 1 : 0
...
resource "aws_route" "ca-central-1_ap-south-1" {
  provider = aws.ca-central-1
  route_table_id = var.ca-central-1.route_table_id

  count = local.ca-central-1 && local.ap-south-1 ? 1 : 0
...
resource "aws_route" "ca-central-1_ap-northeast-2" {
  provider = aws.ca-central-1
  route_table_id = var.ca-central-1.route_table_id

  count = local.ca-central-1 && local.ap-northeast-2 ? 1 : 0
...
resource "aws_route" "ca-central-1_ap-southeast-1" {
  provider = aws.ca-central-1
  route_table_id = var.ca-central-1.route_table_id

  count = local.ca-central-1 && local.ap-southeast-1 ? 1 : 0
...
resource "aws_route" "ca-central-1_ap-southeast-2" {
  provider = aws.ca-central-1
  route_table_id = var.ca-central-1.route_table_id

  count = local.ca-central-1 && local.ap-southeast-2 ? 1 : 0
...
resource "aws_route" "ca-central-1_ap-northeast-1" {
  provider = aws.ca-central-1
  route_table_id = var.ca-central-1.route_table_id

  count = local.ca-central-1 && local.ap-northeast-1 ? 1 : 0
...
resource "aws_route" "ca-central-1_eu-central-1" {
  provider = aws.ca-central-1
  route_table_id = var.ca-central-1.route_table_id
...
resource "aws_route" "ca-central-1_eu-west-1" {
  provider = aws.ca-central-1
  route_table_id = var.ca-central-1.route_table_id
...
resource "aws_route" "ca-central-1_eu-west-2" {
  provider = aws.ca-central-1
  route_table_id = var.ca-central-1.route_table_id
...
resource "aws_route" "ca-central-1_eu-west-3" {
  provider = aws.ca-central-1
  route_table_id = var.ca-central-1.route_table_id

  count = local.ca-central-1 && local.eu-west-3 ? 1 : 0
...
resource "aws_route" "ca-central-1_eu-north-1" {
  provider = aws.ca-central-1
  route_table_id = var.ca-central-1.route_table_id
...
resource "aws_route" "ca-central-1_me-south-1" {
  provider = aws.ca-central-1
  route_table_id = var.ca-central-1.route_table_id

  count = local.ca-central-1 && local.me-south-1 ? 1 : 0
...
resource "aws_route" "ca-central-1_sa-east-1" {
  provider = aws.ca-central-1
  route_table_id = var.ca-central-1.route_table_id
