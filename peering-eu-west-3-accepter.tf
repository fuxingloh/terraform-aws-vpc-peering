resource "aws_vpc_peering_connection_accepter" "us-east-1_eu-west-3" {
...
resource "aws_vpc_peering_connection_accepter" "us-east-2_eu-west-3" {
  provider = aws.eu-west-3
...
resource "aws_vpc_peering_connection_accepter" "us-west-1_eu-west-3" {
  provider = aws.eu-west-3
  vpc_peering_connection_id = aws_vpc_peering_connection.us-west-1_eu-west-3[0].id
  count = local.us-west-1 && local.eu-west-3 ? 1 : 0

  auto_accept = true
  tags = var.tags
}

resource "aws_vpc_peering_connection_accepter" "us-west-2_eu-west-3" {
  provider = aws.eu-west-3
  vpc_peering_connection_id = aws_vpc_peering_connection.us-west-2_eu-west-3[0].id
  count = local.us-west-2 && local.eu-west-3 ? 1 : 0

  auto_accept = true
  tags = var.tags
}

resource "aws_vpc_peering_connection_accepter" "ap-east-1_eu-west-3" {
  provider = aws.eu-west-3
...
resource "aws_vpc_peering_connection_accepter" "ap-south-1_eu-west-3" {
  provider = aws.eu-west-3
...
resource "aws_vpc_peering_connection_accepter" "ap-northeast-2_eu-west-3" {
  provider = aws.eu-west-3
...
resource "aws_vpc_peering_connection_accepter" "ap-southeast-1_eu-west-3" {
  provider = aws.eu-west-3
...
resource "aws_vpc_peering_connection_accepter" "ap-southeast-2_eu-west-3" {
  provider = aws.eu-west-3
...
resource "aws_vpc_peering_connection_accepter" "ap-northeast-1_eu-west-3" {
  provider = aws.eu-west-3
...
resource "aws_vpc_peering_connection_accepter" "ca-central-1_eu-west-3" {
  provider = aws.eu-west-3
...
resource "aws_vpc_peering_connection_accepter" "eu-central-1_eu-west-3" {
  provider = aws.eu-west-3
...
resource "aws_vpc_peering_connection_accepter" "eu-west-1_eu-west-3" {
  provider = aws.eu-west-3
...
resource "aws_vpc_peering_connection_accepter" "eu-west-2_eu-west-3" {
  provider = aws.eu-west-3
